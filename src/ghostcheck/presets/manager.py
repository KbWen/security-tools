    ...
    def __init__(self):
        self.presets = {
            "next.js": {
                ...
                "scan_modules": ["hallucination", "secrets", "env", "ci_cd", "api", "docker", "logic", "shadow_ai", "supply_chain", "context_inflation"],
            ...
            "flutter": {
                ...
                "scan_modules": ["hallucination", "secrets", "mobile", "ci_cd", "rules", "iac", "logic", "shadow_ai", "supply_chain", "context_inflation"],
            ...
            "django": {
                ...
                "scan_modules": ["hallucination", "secrets", "env", "docker", "iac", "logic", "shadow_ai", "supply_chain", "context_inflation"],
            ...
            "fastapi": {
                ...
                "scan_modules": ["hallucination", "secrets", "env", "api", "docker", "logic", "shadow_ai", "supply_chain", "context_inflation"],
            ...
            "terraform": {
                ...
                "scan_modules": ["iac", "secrets", "ci_cd", "shadow_ai", "context_inflation"],
