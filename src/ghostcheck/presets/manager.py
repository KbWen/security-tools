    ...
    def __init__(self):
        self.presets = {
            "next.js": {
                ...
                "scan_modules": ["hallucination", "secrets", "env", "ci_cd", "api", "docker", "logic", "shadow_ai", "supply_chain"],
            ...
            "flutter": {
                ...
                "scan_modules": ["hallucination", "secrets", "mobile", "ci_cd", "rules", "iac", "logic", "shadow_ai", "supply_chain"],
            ...
            "django": {
                ...
                "scan_modules": ["hallucination", "secrets", "env", "docker", "iac", "logic", "shadow_ai", "supply_chain"],
            ...
            "fastapi": {
                ...
                "scan_modules": ["hallucination", "secrets", "env", "api", "docker", "logic", "shadow_ai", "supply_chain"],
